...
(function(){
  ...
  try{
    ...
    st.textContent=
      ...
      '@media (hover:hover) and (pointer:fine) and (max-width:819.98px),(hover:hover) and (pointer:fine) and (max-height:519.98px){.feednav{right:calc(12px + var(--xrail,64px) + 10px)!important}}'+
